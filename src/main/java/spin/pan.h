...
#define _nstates0	168	/* :init: */
#define minseq0	0
#define maxseq0	166
#define _endstate0	167
...
#endif
	unsigned _1_6_flag : 1;
	unsigned _1_6_5_4_exist : 1;
	uchar alphabet[26];
	uchar S[2];
	uchar T[2];
	int _1_2_i;
...
#define Air0	(sizeof(P0) - Offsetof(P0, _1_6_5_4_1_y) - 1*sizeof(int))
